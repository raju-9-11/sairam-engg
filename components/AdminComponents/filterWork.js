...
import AdminWorkProps from './adminWorkProps';
...
export default function Work({work, index, ...props}) {
    ...
    <div>
        ...
        <ListItemText
          ...
          secondary={
            <React.Fragment>
              ...
              {"  - " +   work.priority + " - " + work.description.substring(0,10)+"...."}
            </React.Fragment>
          }
          />
          {!fullScreen &&
      ...
      <Dialog fullScreen={fullScreen} className={classes.root} open={open} onClose={handleClose} aria-labelledby="form-dialog-title">
        ...
        <DialogContent>
         ...
         <AdminWorkProps view work={work} close={()=>setOpen(false)}  />
        </DialogContent>
        <DialogActions>
